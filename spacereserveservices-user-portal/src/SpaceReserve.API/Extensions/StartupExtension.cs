...
namespace SpaceReserve.API.Extensions
{
    public static class StartupExtension
    {
        ...
        public static void AddStartupServices(this WebApplicationBuilder builder)
        {
            ...
            builder.Services.AddHangfireServer(optons =>{
                optons.Queues = new[]{"user-side"};
            });

            builder.Services.AddControllers()
            .AddFluentValidation(fv => fv.RegisterValidatorsFromAssembly(Assembly.Load("SpaceReserve.AppService")));
